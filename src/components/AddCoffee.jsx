...
const AddCoffee = () => {
  ...
  return (
    <div className="bg-[#F4F3F0] p-24">
      <h2 className="text-3xl front-extrabold">Add a Coffee</h2>
      <form onSubmit={handleAddCoffee}>
        ...
        <div className="md:flex mb-8">
          <div className="form-control md:w-1/2">
            ...
            <label className="input-group">
              <input
                type="text" name="name" placeholder="Coffee Name"
        ...
        <div className="md:flex mb-8">
          <div className="form-control md:w-1/2">
            ...
            <label className="input-group">
              <input
                type="text" name="supplier" placeholder=" COffee Supplier"
                className="input input-bordered w-full"
              />
            </label>
          </div>
        ...
        <div className="md:flex mb-8">
          <div className="form-control md:w-1/2">
            ...
            <label className="input-group">
              <input
                type="text" name="category" placeholder="Enter coffee category"
                className="input input-bordered w-full"
              />
            </label>
          </div>
